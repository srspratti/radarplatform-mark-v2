...
FEATURES: dict[str, tuple[str, str, str]] = {
    ...
    "engagement_trend":  ("premium", "Tendance d'engagement",
                          "Flèche semaine sur semaine sur chaque client — qui monte, qui décroche."),
    ...
    "alert_sms":         ("gold", "Avis texto de nouvelles inscriptions",
                          "Texto « n nouvelles inscriptions » avec le lien du portail — le client revient dans la Vitrine, pas dans Centris."),
    "client_documents":  ("gold", "Coffre à documents client",
                          "Documents et notes échangés dans le portail — plus de pièces jointes par courriel."),
    "listing_photos":    ("gold", "Photos d'inscription réelles",
                          "Vos photos remplacent les visuels génériques sur les cartes Vitrine."),
    "visit_scheduler_live": ("gold", "Créneaux de visite réels",
                          "Le client réserve dans VOS plages — la demande arrive en tâche à confirmer."),
    "offer_checklist":   ("gold", "Aide-mémoire d'offre",
                          "Liste de préparation à la promesse d'achat, suivie dans le portail."),
    "visit_feedback":    ("gold", "Rétroaction post-visite",
                          "Mini-sondage texté après chaque visite — la réponse nourrit l'engagement."),
    "mortgage_handoff":  ("gold", "Référence hypothécaire",
                          "Bouton « parler financement » dans le portail — signal fort + partenaire référé."),
    "portal_pwa":        ("gold", "Portail installable",
                          "Vitrine sur l'écran d'accueil du client + alertes de nouvelles inscriptions."),
    ...
    "seller_intelligence": ("platinum", "Intelligence vendeur",
                          "Qui va vendre bientôt — score de mise en vente + approche courriel/texto/voix balisée LCAP."),
    "deadline_sentinel": ("platinum", "Sentinelle d'échéances",
                          "Dates de conditions (financement, inspection) surveillées — alerte avant l'expiration."),
    "data_rights":       ("platinum", "Droits Loi 25",
                          "Export complet et effacement des données d'un client en un appel d'API."),
    "real_map":          ("platinum", "Carte réelle",
                          "Carte OpenStreetMap géocodée dans le portail au lieu de la carte stylisée."),
    "co_buyer":          ("platinum", "Mode co-acheteur",
                          "Deux acheteurs, un portail — chaque geste identifie qui l'a posé."),
}
